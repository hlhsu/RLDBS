...
class oscillatorEnv_dis(gym.Env):
  ...
  def __init__(self, len_state=10000, ep_length=10000, nosc=1000, epsilon=0.03, frrms=0.1,random=False, #len_state = 250
               sigmoid=False):
  ...
  def step(self, action):
      ...
      val =  action #float(action) / 20 - 0.5 #float(action-1) / 10 - 1 
      ...
      return arrayed_version, self.x_val, self.x_state
